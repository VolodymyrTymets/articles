...
## Проблема 2 Запитів все більше і більше
...
За цим принципом нащ роут `users` повинен виглядати наступним чином: 
...
```
Також ви можете фільтрувати поля оргпнізації якщо вони вам не потрібні зп таким же принципом який описувався вище.
